...
export const Navbar = ({ onOpenCreateUser }) => {
  const { currentUser, logout } = useAccounting();
  ...
  const isCustomer = currentUser && (currentUser.role === 'USER' || currentUser.role === 'CUSTOMER');
            ...
            {currentUser ? (
              <div className="flex items-center space-x-2">
                ...
                <div className="relative">
                  ...
                  {profileOpen && (
                    <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl shadow-2xl border border-slate-100 py-3 z-50 animate-in fade-in slide-in-from-top-1 duration-150">
                      <div className="px-4 pb-3 border-b border-slate-100">
                        ...
                        <div className="mt-2 flex items-center space-x-2">
                          <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider ${
                            ...
                            {currentUser.role === 'USER' ? 'CUSTOMER' : currentUser.role}
                          </span>
                          <span className="text-[10px] text-slate-400 font-mono">@{currentUser.loginId}</span>
                        </div>
                      </div>
                      ...
                      <div className="pt-2 px-2">
                        <button
                          ...
                          className="w-full flex items-center space-x-2 px-3 py-2 rounded-xl text-xs font-semibold text-red-600 hover:bg-red-50 hover:text-red-700 transition-colors"
                        >
